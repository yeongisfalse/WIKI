...
RAMI 4.0(Reference Architecture Model Industrie 4.0)은 산업 4.0 환경의 구성요소와 관계를 세 개의 축으로 배치해 설명하는 3차원 참조 아키텍처 모델이다. 디지털트윈이 어떤 대상·수명주기·기능 계층에 걸쳐 있는지 공통 언어로 표시하는 데 사용할 수 있다.
...
1. **대상**: 제품·센서·기계·작업대·공정·공장·기업·물류 중 어디인가?
2. **수명주기**: 설계·제조·사용·서비스 중 어느 단계인가?
3. **층**: 데이터 수집과 연결, 정보 모델, 기능, 사업 의사결정 중 어느 층을 다루는가?
